...
//import handleShow from "../components/modalHelper";
...
export function SingleSemesterDisplay({ course_set, semester_number, userSemesters, updateSemesters }:SS_Semester) :JSX.Element {
        ...
        return (
            <tr>
                ...
                <td className="editcourse">
                    ...
                    <button type="button" className="btn btn-outline-secondary m-1" onClick={()=> setShow(true)}>Edit</button>                                                        
    ...
    return <div className="">
        ...
        <div>
            <Mod setShow={setShow} showModal={showModal}></Mod>
        </div>
    </div >;
